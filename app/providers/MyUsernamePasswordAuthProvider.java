...
//		} else {
//			if (!u.emailValidated) {
////Added to remove email verification
...
//		}
	...
	protected Body getPasswordResetMailingBody(final String token,
		...
		final String html = getEmailTemplate(
				"views.html.user_account.email.password_reset", langCode, url,
				token, user.name, user.email);
		final String text = getEmailTemplate(
				"views.txt.user_account.email.password_reset", langCode, url, token,
	...
	protected Body getVerifyEmailMailingBodyAfterSignup(final String token,
		...
		final String html = getEmailTemplate(
				"views.html.user_account.email.verify_email", langCode, url, token,
				user.name, user.email);
		final String text = getEmailTemplate(
				"views.txt.user_account.email.verify_email", langCode, url, token,
				user.name, user.email);
