...
public class Account extends Controller {
	...
	public static Result askLink() {
		...
		if (u == null) {
			// user_account to link could not be found, silently redirect to login
	...
	public static Result askMerge() {
		...
		// UserController.findByAuthUserIdentity(newUser)
	...
	public static Result doMerge() {
		...
		final Form<Accept> filledForm = ACCEPT_FORM.bindFromRequest();
		if (filledForm.hasErrors()) {
			// UserController did not select whether to merge or not merge
