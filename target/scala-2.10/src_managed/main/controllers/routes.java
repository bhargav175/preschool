...
public static final controllers.ReverseContentController ContentController = new controllers.ReverseContentController();
...
public static final controllers.javascript.ReverseContentController ContentController = new controllers.javascript.ReverseContentController();
...
public static final controllers.javascript.ReverseAccount Account = new controllers.javascript.ReverseAccount();
}
public static class ref {
public static final controllers.ref.ReverseAssets Assets = new controllers.ref.ReverseAssets();
public static final controllers.ref.ReverseContentController ContentController = new controllers.ref.ReverseContentController();
...
public static final controllers.ref.ReverseAccount Account = new controllers.ref.ReverseAccount();
}
}
